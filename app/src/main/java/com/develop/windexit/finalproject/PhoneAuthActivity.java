...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    //  myRef.child("User").child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            myRef.child("User").child(userID).child(userPhone).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot snapshot) {
                                    if (snapshot.getValue() != null) {

                                        Intent y = new Intent(PhoneAuthActivity.this, SignUp.class);
                                        ...
                                        //myRef.child("User").child(userID).setValue("true");

                                        //    myRef.child("users").child(userID).child("Name").setValue("true");

                                        //myRef.child("User").child(userID).child("contact").setValue(contactno);

                                        myRef.child("User").child(userID).setValue(contactno);
